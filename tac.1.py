...
def boardPrint():
    b0 = "_|a  b  c"
    b1 =  "a" + str([beta.r0[0][0],beta.r0[1][0],beta.r0[2][0]])
    b2 =  "b" + str([beta.r1[0][0],beta.r1[1][0],beta.r1[2][0]])
    b3 =  "c" + str([beta.r2[0][0],beta.r2[1][0],beta.r2[2][0]])
    print "\n" + b0 + "\n" + b1 + "\n" + b2 + "\n" + b3 + "\n"
...
def opthreadF(opMove):
    ...
    while opMove == 1:
        ...
        while index_1 < 1000 + int(time.clock() * 10000000):
            index_1 += 1
...
while bool == 1:   
    ...
    a_1 = thread.start_new_thread(opthreadF, (1,))
