...
while index < len(combinations):
    ...
    while index_1_1 < len(combinations[index]):
        ...
        while bool == 0:
            ...
            while index_1_2 < len(combinations[index][index_1_1]):
                if combinations[index][index_1_1 - 1] == combinations[index][index_1_1]:
                    bool = 0
                    A = []
                    ...
                    while index_2_1 < 2:
                        A.append(combinations[index][index_1_1][index_2_1])
                        index_2_1 += 1
                    
                    index_2_1 = 0
                
                    while index_2_1 < 2:
                        combinations[index][index_1_1][index_2_1] = A[(index_2_1 + 1)%len(A)]
